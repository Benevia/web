(() => {
  const anclasAnteriores = {
    '#dueno': '/duenos-fundadores',
    '#dueno-fundador': '/duenos-fundadores',
    '#familia': '/empresas-familiares',
    '#empresa-familiar': '/empresas-familiares',
    '#operacion': '/directivos-gerentes',
    '#empresas': '/para-quien',
    '#es-para-usted': '/para-quien',
    '#que-hacemos': '/como-trabajamos',
